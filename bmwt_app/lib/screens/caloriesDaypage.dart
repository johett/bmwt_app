...
class CaloriesDayPage extends StatelessWidget {
  ...
  static const routename = 'Daily calories summary';
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return ListView.separated(
                    // just shows as a listview all the single days of the chosen week
                      ...
                      return ListTile(
                        ...
                        leading: Text('${index + 1}',
                            style: TextStyle(
                                ...
                                fontSize: 20)),
                        title: Text(
                            'Day: ${caloriesDay.day.day}/${caloriesDay.day.month}/${caloriesDay.day.year}'),
                        subtitle: (caloriesDay.activityCalories == null)
                            ? const Text('No data avaiables')
                            : ((caloriesDay.activityCalories! + measBMR) >
                                    dietCalories)
                                ? Text(
                                    'Deficit of ${(caloriesDay.activityCalories! + measBMR - dietCalories).toInt()} kcal',
                                    style: TextStyle(color: Colors.red))
                                : Text(
                                    'Surplus of ${(dietCalories - caloriesDay.activityCalories! - measBMR).toInt()} kcal',
